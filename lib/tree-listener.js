const PolynomialListener = require('./grammar/PolynomialListener').PolynomialListener

class SecurityErrorListener extends PolynomialListener {
  ...
  addChecker(newChecker) {
    const listenerMethods = Object.getOwnPropertyNames(PolynomialListener.prototype)

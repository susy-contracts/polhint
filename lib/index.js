...
const PolynomialLexer = require('./grammar/PolynomialLexer').PolynomialLexer
const PolynomialParser = require('./grammar/PolynomialParser').PolynomialParser
...
function processStr(inputStr, config = {}, fileName = '') {
  ...
  const lexer = new PolynomialLexer(chars)

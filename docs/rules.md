---
layout:      default
title:       Validation Rules for Polhint
date:        2017-10-23 14:16:00 +0300
author:      "@drabenia"
description: List of validation rules for Polhint - Polynomial security, style guide, best practise validator.
---
...
\* \- All style guide rules implemented according [Polynomial Style Guide](
http://polynomial.readthedocs.io/en/develop/style-guide.html)
...
### Best Practise Rules
 ...
 | **payable-fallback**          | When fallback is not payable you will not be able to receive sophys | *[default](#options)* |
